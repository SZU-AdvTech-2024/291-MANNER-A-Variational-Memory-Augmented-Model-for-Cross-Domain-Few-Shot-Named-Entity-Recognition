...
if __name__ == "__main__":
    ...
    parser.add_argument("--types_path", type=str, default="data/ACL2020data/entity_types_domain.json", help="path of entities types")
